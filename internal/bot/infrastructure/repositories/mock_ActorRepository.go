...
func (_m *ActorRepository_mock) Add(_a0 context.Context, _a1 Actor) (*Actor, error) {
	...
	if rf, ok := ret.Get(1).(func(context.Context, Actor) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *ActorRepository_mock_Add_Call) Run(run func(_a0 context.Context, _a1 Actor)) *ActorRepository_mock_Add_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Actor))
	})
	return _c
}
...
func (_m *ActorRepository_mock) Query(_a0 context.Context, _a1 Specification) ([]Actor, error) {
	...
	var r0 []Actor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, Specification) ([]Actor, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Specification) []Actor); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]Actor)
...
func (_m *ActorRepository_mock) Remove(_a0 context.Context, _a1 Actor) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, Actor) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
