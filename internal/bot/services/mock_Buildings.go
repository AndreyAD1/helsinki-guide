...
// GetNearestBuildingPreviews provides a mock function with given fields: ctx, distance, latitude, longitude, limit, offset
func (_m *Buildings_mock) GetNearestBuildingPreviews(ctx context.Context, distance int, latitude float64, longitude float64, limit int, offset int) ([]BuildingPreview, error) {
	...
	var r0 []BuildingPreview
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, float64, float64, int, int) ([]BuildingPreview, error)); ok {
		return rf(ctx, distance, latitude, longitude, limit, offset)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, float64, float64, int, int) []BuildingPreview); ok {
...
//   - limit int
//   - offset int
func (_e *Buildings_mock_Expecter) GetNearestBuildingPreviews(ctx interface{}, distance interface{}, latitude interface{}, longitude interface{}, limit interface{}, offset interface{}) *Buildings_mock_GetNearestBuildingPreviews_Call {
	return &Buildings_mock_GetNearestBuildingPreviews_Call{Call: _e.mock.On("GetNearestBuildingPreviews", ctx, distance, latitude, longitude, limit, offset)}
}

func (_c *Buildings_mock_GetNearestBuildingPreviews_Call) Run(run func(ctx context.Context, distance int, latitude float64, longitude float64, limit int, offset int)) *Buildings_mock_GetNearestBuildingPreviews_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Buildings_mock_GetNearestBuildingPreviews_Call) RunAndReturn(run func(context.Context, int, float64, float64, int, int) ([]BuildingPreview, error)) *Buildings_mock_GetNearestBuildingPreviews_Call {
	_c.Call.Return(run)
	return _c
}
